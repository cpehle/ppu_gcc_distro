...
#define ggc_alloc_builtin_hash_struct() ((struct builtin_hash_struct *)(ggc_internal_alloc_stat (sizeof (struct builtin_hash_struct) MEM_STAT_INFO)))
#define ggc_alloc_cleared_builtin_hash_struct() ((struct builtin_hash_struct *)(ggc_internal_cleared_alloc_stat (sizeof (struct builtin_hash_struct) MEM_STAT_INFO)))
#define ggc_alloc_vec_builtin_hash_struct(n) ((struct builtin_hash_struct *)(ggc_internal_vec_alloc_stat (sizeof (struct builtin_hash_struct), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_builtin_hash_struct(n) ((struct builtin_hash_struct *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct builtin_hash_struct), n MEM_STAT_INFO)))
#define ggc_alloc_toc_hash_struct() ((struct toc_hash_struct *)(ggc_internal_alloc_stat (sizeof (struct toc_hash_struct) MEM_STAT_INFO)))
#define ggc_alloc_cleared_toc_hash_struct() ((struct toc_hash_struct *)(ggc_internal_cleared_alloc_stat (sizeof (struct toc_hash_struct) MEM_STAT_INFO)))
#define ggc_alloc_vec_toc_hash_struct(n) ((struct toc_hash_struct *)(ggc_internal_vec_alloc_stat (sizeof (struct toc_hash_struct), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_toc_hash_struct(n) ((struct toc_hash_struct *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct toc_hash_struct), n MEM_STAT_INFO)))
...
extern void * ggc_alloc_splay_tree_builtin_hash_struct_htab (int, void *);
extern void * ggc_alloc_splay_tree_toc_hash_struct_htab (int, void *);
