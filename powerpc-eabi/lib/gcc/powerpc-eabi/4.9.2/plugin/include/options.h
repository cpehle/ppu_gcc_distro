...
#endif
#ifdef GENERATOR_FILE
extern int rs6000_lra_flag;
#else
  int x_rs6000_lra_flag;
#define rs6000_lra_flag global_options.x_rs6000_lra_flag
#endif
#ifdef GENERATOR_FILE
...
#define OPTION_MASK_FPRND (HOST_WIDE_INT_1 << 8)
#define OPTION_MASK_DFP (HOST_WIDE_INT_1 << 9)
#define OPTION_MASK_SOFT_FLOAT (HOST_WIDE_INT_1 << 10)
#define OPTION_MASK_HTM (HOST_WIDE_INT_1 << 11)
#define OPTION_MASK_ISEL (HOST_WIDE_INT_1 << 12)
#define OPTION_MASK_MFCRF (HOST_WIDE_INT_1 << 13)
#define OPTION_MASK_MFPGPR (HOST_WIDE_INT_1 << 14)
#define OPTION_MASK_MINIMAL_TOC (HOST_WIDE_INT_1 << 15)
#define OPTION_MASK_MULHW (HOST_WIDE_INT_1 << 16)
#define OPTION_MASK_MULTIPLE (HOST_WIDE_INT_1 << 17)
#define OPTION_MASK_NO_UPDATE (HOST_WIDE_INT_1 << 18)
#define OPTION_MASK_S2PP (HOST_WIDE_INT_1 << 19)
#define OPTION_MASK_POPCNTB (HOST_WIDE_INT_1 << 20)
#define OPTION_MASK_POPCNTD (HOST_WIDE_INT_1 << 21)
#define OPTION_MASK_P8_FUSION (HOST_WIDE_INT_1 << 22)
#define OPTION_MASK_P8_FUSION_SIGN (HOST_WIDE_INT_1 << 23)
#define OPTION_MASK_P8_VECTOR (HOST_WIDE_INT_1 << 24)
#define OPTION_MASK_PPC_GFXOPT (HOST_WIDE_INT_1 << 25)
#define OPTION_MASK_PPC_GPOPT (HOST_WIDE_INT_1 << 26)
#define OPTION_MASK_POWERPC64 (HOST_WIDE_INT_1 << 27)
#define OPTION_MASK_QUAD_MEMORY (HOST_WIDE_INT_1 << 28)
#define OPTION_MASK_QUAD_MEMORY_ATOMIC (HOST_WIDE_INT_1 << 29)
#define OPTION_MASK_RECIP_PRECISION (HOST_WIDE_INT_1 << 30)
#define OPTION_MASK_RELOCATABLE (HOST_WIDE_INT_1 << 31)
#define OPTION_MASK_STRICT_ALIGN (HOST_WIDE_INT_1 << 32)
#define OPTION_MASK_STRING (HOST_WIDE_INT_1 << 33)
#define OPTION_MASK_UPPER_REGS_DF (HOST_WIDE_INT_1 << 34)
#define OPTION_MASK_UPPER_REGS_SF (HOST_WIDE_INT_1 << 35)
#define OPTION_MASK_VSX (HOST_WIDE_INT_1 << 36)
#define OPTION_MASK_VSX_TIMODE (HOST_WIDE_INT_1 << 37)
 #if defined(HOST_BITS_PER_WIDE_INT) && 38 >= HOST_BITS_PER_WIDE_INT
...
#define TARGET_S2PP ((rs6000_isa_flags & OPTION_MASK_S2PP) != 0)
#define TARGET_S2PP_P(rs6000_isa_flags) ((rs6000_isa_flags & OPTION_MASK_S2PP) != 0)
...
enum opt_code
{
  ...
  OPT_Wnormalized_ = 294,                    /* -Wnormalized= */
  OPT_Wnull = 295,                           /* -Wnull */
  OPT_Wold_style_cast = 296,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 297,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 298,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 299,                    /* -Wopenmp-simd */
  OPT_Wout_of_date = 300,                    /* -Wout-of-date */
  OPT_Wover_ann = 301,                       /* -Wover-ann */
  OPT_Woverflow = 302,                       /* -Woverflow */
  OPT_Woverlength_strings = 303,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 304,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 305,                  /* -Woverride-init */
  OPT_Wp_ = 306,                             /* -Wp, */
  OPT_Wpacked = 307,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 308,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 309,                         /* -Wpadded */
  OPT_Wparam_assign = 310,                   /* -Wparam-assign */
  OPT_Wparentheses = 311,                    /* -Wparentheses */
  OPT_Wpedantic = 312,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 313,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 314,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 315,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 316,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 317,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 318,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 319,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 320,                       /* -Wprotocol */
  OPT_Wpsabi = 321,                          /* -Wpsabi */
  OPT_Wraw = 322,                            /* -Wraw */
  OPT_Wreal_q_constant = 323,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 324,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 325,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 326,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 327,            /* -Wredundant-modifiers */
  OPT_Wreorder = 328,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 329,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 330,                    /* -Wreturn-type */
  OPT_Wselector = 331,                       /* -Wselector */
  OPT_Wsequence_point = 332,                 /* -Wsequence-point */
  OPT_Wserial = 333,                         /* -Wserial */
  OPT_Wshadow = 334,                         /* -Wshadow */
  OPT_Wsign_compare = 335,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 336,                /* -Wsign-conversion */
  OPT_Wsign_promo = 337,                     /* -Wsign-promo */
  OPT_Wsizeof_pointer_memaccess = 338,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 339,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 340,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 341,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 342,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 343,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 344,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 345,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 346,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 347,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 348,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 349,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 350,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 351,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 352,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 353,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 354,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 355,                       /* -Wsuppress */
  OPT_Wsurprising = 356,                     /* -Wsurprising */
  OPT_Wswitch = 357,                         /* -Wswitch */
  OPT_Wswitch_default = 358,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 359,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 360,                      /* -Wsync-nand */
  OPT_Wsynth = 361,                          /* -Wsynth */
  OPT_Wsynthetic_access = 362,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 363,                 /* -Wsystem-headers */
  OPT_Wtabs = 364,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 365,                /* -Wtarget-lifetime */
  OPT_Wtasks = 366,                          /* -Wtasks */
  OPT_Wtraditional = 367,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 368,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 369,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 370,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 371,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 372,                    /* -Wtype-limits */
  OPT_Wuncheck = 373,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 374,            /* -Wundeclared-selector */
  OPT_Wundef = 375,                          /* -Wundef */
  OPT_Wunderflow = 376,                      /* -Wunderflow */
  OPT_Wuninitialized = 377,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 378,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 379,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 380,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 381, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 382,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 383,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 384,                         /* -Wunused */
  OPT_Wunused_argument = 385,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 386,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 387,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 388,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 389,                /* -Wunused-function */
  OPT_Wunused_import = 390,                  /* -Wunused-import */
  OPT_Wunused_label = 391,                   /* -Wunused-label */
  OPT_Wunused_local = 392,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 393,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 394,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 395,               /* -Wunused-parameter */
  OPT_Wunused_private = 396,                 /* -Wunused-private */
  OPT_Wunused_result = 397,                  /* -Wunused-result */
  OPT_Wunused_thrown = 398,                  /* -Wunused-thrown */
  OPT_Wunused_value = 399,                   /* -Wunused-value */
  OPT_Wunused_variable = 400,                /* -Wunused-variable */
  OPT_Wuseless_cast = 401,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 402,             /* -Wuseless-type-check */
  OPT_Wvarargs = 403,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 404,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 405,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 406,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 407,            /* -Wvirtual-move-assign */
  OPT_Wvla = 408,                            /* -Wvla */
  OPT_Wvolatile_register_var = 409,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 410,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 411,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 412,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 413,                       /* -Wzerotrip */
  OPT_Xassembler = 414,                      /* -Xassembler */
  OPT_Xlinker = 415,                         /* -Xlinker */
  OPT_Xpreprocessor = 416,                   /* -Xpreprocessor */
  OPT_Z = 417,                               /* -Z */
  OPT_ansi = 418,                            /* -ansi */
  OPT_aux_info = 419,                        /* -aux-info */
  /* OPT_aux_info_ = 420, */                 /* -aux-info= */
  OPT_auxbase = 421,                         /* -auxbase */
  OPT_auxbase_strip = 422,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 423, */             /* -bootclasspath */
  OPT_c = 424,                               /* -c */
  /* OPT_classpath = 425, */                 /* -classpath */
  OPT_coverage = 426,                        /* -coverage */
  OPT_cpp = 427,                             /* -cpp */
  OPT_cpp_ = 428,                            /* -cpp= */
  OPT_d = 429,                               /* -d */
  OPT_dumpbase = 430,                        /* -dumpbase */
  OPT_dumpdir = 431,                         /* -dumpdir */
  OPT_dumpmachine = 432,                     /* -dumpmachine */
  OPT_dumpspecs = 433,                       /* -dumpspecs */
  OPT_dumpversion = 434,                     /* -dumpversion */
  OPT_e = 435,                               /* -e */
  /* OPT_encoding = 436, */                  /* -encoding */
  OPT_export_dynamic = 437,                  /* -export-dynamic */
  OPT_extdirs = 438,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 439, */               /* -fCLASSPATH= */
  OPT_fPIC = 440,                            /* -fPIC */
  OPT_fPIE = 441,                            /* -fPIE */
  OPT_fRTS_ = 442,                           /* -fRTS= */
  OPT_fabi_version_ = 443,                   /* -fabi-version= */
  OPT_faccess_control = 444,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 445,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 446,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 447,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 448,                  /* -falign-commons */
  OPT_falign_functions = 449,                /* -falign-functions */
  OPT_falign_functions_ = 450,               /* -falign-functions= */
  OPT_falign_jumps = 451,                    /* -falign-jumps */
  OPT_falign_jumps_ = 452,                   /* -falign-jumps= */
  OPT_falign_labels = 453,                   /* -falign-labels */
  OPT_falign_labels_ = 454,                  /* -falign-labels= */
  OPT_falign_loops = 455,                    /* -falign-loops */
  OPT_falign_loops_ = 456,                   /* -falign-loops= */
  OPT_fall_intrinsics = 457,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 458, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 459,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 460,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 461, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 462, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 463, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 464, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 465, */  /* -fargument-noalias-global */
  OPT_fasm = 466,                            /* -fasm */
  OPT_fassert = 467,                         /* -fassert */
  OPT_fassociative_math = 468,               /* -fassociative-math */
  OPT_fassume_compiled = 469,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 470,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 471,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 472,                   /* -fauto-inc-dec */
  OPT_fautomatic = 473,                      /* -fautomatic */
  OPT_faux_classpath = 474,                  /* -faux-classpath */
  OPT_fbackslash = 475,                      /* -fbackslash */
  OPT_fbacktrace = 476,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 477,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 478,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 479,              /* -fbootstrap-classes */
  OPT_fbounds_check = 480,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 481,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 482,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 483,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 484,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 485,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 486,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 487,                        /* -fbuiltin */
  OPT_fbuiltin_ = 488,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 489,                    /* -fcall-saved- */
  OPT_fcall_used_ = 490,                     /* -fcall-used- */
  OPT_fcaller_saves = 491,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 492,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 493,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 494,                /* -fcheck-data-deps */
  OPT_fcheck_new = 495,                      /* -fcheck-new */
  OPT_fcheck_references = 496,               /* -fcheck-references */
  OPT_fcheck_ = 497,                         /* -fcheck= */
  OPT_fcilkplus = 498,                       /* -fcilkplus */
  OPT_fclasspath_ = 499,                     /* -fclasspath= */
  OPT_fcoarray_ = 500,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 501,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 502,                         /* -fcommon */
  OPT_fcompare_debug = 503,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 504,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 505,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 506,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 507,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 508,                  /* -fcond-mismatch */
  OPT_fconserve_space = 509,                 /* -fconserve-space */
  OPT_fconserve_stack = 510,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 511,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 512,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 513,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 514,          /* -fconvert=little-endian */
  OPT_fconvert_native = 515,                 /* -fconvert=native */
  OPT_fconvert_swap = 516,                   /* -fconvert=swap */
  OPT_fcprop_registers = 517,                /* -fcprop-registers */
  OPT_fcray_pointer = 518,                   /* -fcray-pointer */
  OPT_fcrossjumping = 519,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 520,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 521, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 522,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 523,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 524,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 525,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 526,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 527,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 528,                       /* -fdbg-cnt= */
  OPT_fdce = 529,                            /* -fdce */
  OPT_fdebug_cpp = 530,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 531,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 532,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 533,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 534,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 535,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 536, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 537,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 538,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 539,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 540,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 541,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 542,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 543,                   /* -fdevirtualize */
  OPT_fdevirtualize_speculatively = 544,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 545, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 546,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 547,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 548,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 549,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 550,                /* -fdirectives-only */
  OPT_fdisable_ = 551,                       /* -fdisable- */
  OPT_fdisable_assertions = 552,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 553,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 554,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 555,         /* -fdollars-in-identifiers */
  OPT_fdse = 556,                            /* -fdse */
  OPT_fdump_ = 557,                          /* -fdump- */
  OPT_fdump_ada_spec = 558,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 559,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 560, */                /* -fdump-core */
  OPT_fdump_final_insns = 561,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 562,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 563,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 564,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 565,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 566,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 567,                /* -fdump-parse-tree */
  OPT_fdump_passes = 568,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 569,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 570,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 571,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 572,                 /* -fearly-inlining */
  OPT_felide_constructors = 573,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 574,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 575, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 576,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 577,        /* -femit-class-debug-always */
  OPT_femit_class_file = 578,                /* -femit-class-file */
  OPT_femit_class_files = 579,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 580,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 581,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 582,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 583,                        /* -fenable- */
  OPT_fenable_assertions = 584,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 585,             /* -fenable-assertions= */
  OPT_fencoding_ = 586,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 587,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 588, */           /* -fenum-int-equiv */
  OPT_fexceptions = 589,                     /* -fexceptions */
  OPT_fexcess_precision_ = 590,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 591,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 592,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 593,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 594,                       /* -fextdirs= */
  OPT_fextended_identifiers = 595,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 596,                /* -fextern-tls-init */
  OPT_fexternal_blas = 597,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 598, */       /* -fexternal-templates */
  OPT_ff2c = 599,                            /* -ff2c */
  OPT_ffast_math = 600,                      /* -ffast-math */
  OPT_ffat_lto_objects = 601,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 602,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 603,               /* -ffinite-math-only */
  OPT_ffixed_ = 604,                         /* -ffixed- */
  OPT_ffixed_form = 605,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 606,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 607,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 608,                    /* -ffloat-store */
  OPT_ffor_scope = 609,                      /* -ffor-scope */
  /* OPT_fforce_addr = 610, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 611,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 612,              /* -fforward-propagate */
  OPT_ffp_contract_ = 613,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 614,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 615,                      /* -ffpe-trap= */
  OPT_ffree_form = 616,                      /* -ffree-form */
  OPT_ffree_line_length_ = 617,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 618,          /* -ffree-line-length-none */
  OPT_ffreestanding = 619,                   /* -ffreestanding */
  OPT_ffriend_injection = 620,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 621,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 622,                   /* -ffunction-cse */
  OPT_ffunction_sections = 623,              /* -ffunction-sections */
  OPT_fgcse = 624,                           /* -fgcse */
  OPT_fgcse_after_reload = 625,              /* -fgcse-after-reload */
  OPT_fgcse_las = 626,                       /* -fgcse-las */
  OPT_fgcse_lm = 627,                        /* -fgcse-lm */
  OPT_fgcse_sm = 628,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 629,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 630,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 631,                         /* -fgnu-tm */
  OPT_fgnu_unique = 632,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 633,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 634,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 635,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 636,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 637,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 638,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 639,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 640,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 641,                       /* -fgraphite */
  OPT_fgraphite_identity = 642,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 643,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 644, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 645, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 646,           /* -fhash-synchronization */
  /* OPT_fhelp = 647, */                     /* -fhelp */
  /* OPT_fhelp_ = 648, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 649,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 650, */                /* -fhonor-std */
  OPT_fhosted = 651,                         /* -fhosted */
  /* OPT_fhuge_objects = 652, */             /* -fhuge-objects */
  OPT_fident = 653,                          /* -fident */
  OPT_fif_conversion = 654,                  /* -fif-conversion */
  OPT_fif_conversion2 = 655,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 656,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 657,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 658,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 659,             /* -fimplicit-templates */
  OPT_findirect_classes = 660,               /* -findirect-classes */
  OPT_findirect_dispatch = 661,              /* -findirect-dispatch */
  OPT_findirect_inlining = 662,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 663,         /* -finhibit-size-directive */
  OPT_finit_character_ = 664,                /* -finit-character= */
  OPT_finit_integer_ = 665,                  /* -finit-integer= */
  OPT_finit_local_zero = 666,                /* -finit-local-zero */
  OPT_finit_logical_ = 667,                  /* -finit-logical= */
  OPT_finit_real_ = 668,                     /* -finit-real= */
  OPT_finline = 669,                         /* -finline */
  OPT_finline_atomics = 670,                 /* -finline-atomics */
  OPT_finline_functions = 671,               /* -finline-functions */
  OPT_finline_functions_called_once = 672,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 673, */            /* -finline-limit- */
  OPT_finline_limit_ = 674,                  /* -finline-limit= */
  OPT_finline_small_functions = 675,         /* -finline-small-functions */
  OPT_finput_charset_ = 676,                 /* -finput-charset= */
  OPT_finstrument_functions = 677,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 678,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 679,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 680,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 681,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 682,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 683,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 684,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 685, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 686,                    /* -fipa-profile */
  OPT_fipa_pta = 687,                        /* -fipa-pta */
  OPT_fipa_pure_const = 688,                 /* -fipa-pure-const */
  OPT_fipa_reference = 689,                  /* -fipa-reference */
  OPT_fipa_sra = 690,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 691, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 692,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 693,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 694,              /* -fira-loop-pressure */
  OPT_fira_region_ = 695,                    /* -fira-region= */
  OPT_fira_share_save_slots = 696,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 697,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 698,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 699,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 700,/* -fisolate-erroneous-paths-dereference */
  OPT_fivopts = 701,                         /* -fivopts */
  OPT_fjni = 702,                            /* -fjni */
  OPT_fjump_tables = 703,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 704,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 705,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 706,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 707, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 708,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 709,             /* -fleading-underscore */
  ...
  OPT_m32 = 1067,                            /* -m32 */
  OPT_m64 = 1068,                            /* -m64 */
  OPT_mabi_altivec = 1069,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1070,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1071,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1072,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1073,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1074,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1075,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1076,                /* -mabi=no-altivec */
  OPT_mabi_no_spe = 1077,                    /* -mabi=no-spe */
  OPT_mabi_spe = 1078,                       /* -mabi=spe */
  OPT_mads = 1079,                           /* -mads */
  OPT_maix_struct_return = 1080,             /* -maix-struct-return */
  OPT_malign_ = 1081,                        /* -malign- */
  OPT_malign_branch_targets = 1082,          /* -malign-branch-targets */
  OPT_mallow_df_permute = 1083,              /* -mallow-df-permute */
  OPT_mallow_movmisalign = 1084,             /* -mallow-movmisalign */
  OPT_maltivec = 1085,                       /* -maltivec */
  OPT_maltivec_be = 1086,                    /* -maltivec=be */
  OPT_maltivec_le = 1087,                    /* -maltivec=le */
  OPT_malways_hint = 1088,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1089,       /* -mavoid-indexed-addresses */
  OPT_mbig = 1090,                           /* -mbig */
  OPT_mbig_endian = 1091,                    /* -mbig-endian */
  OPT_mbit_align = 1092,                     /* -mbit-align */
  OPT_mbit_word = 1093,                      /* -mbit-word */
  OPT_mblock_move_inline_limit_ = 1094,      /* -mblock-move-inline-limit= */
  OPT_mbss_plt = 1095,                       /* -mbss-plt */
  OPT_mcall_ = 1096,                         /* -mcall- */
  OPT_mcmpb = 1097,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1098,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1099,                          /* -mcpu= */
  OPT_mcrypto = 1100,                        /* -mcrypto */
  OPT_mdebug_ = 1101,                        /* -mdebug= */
  OPT_mdirect_move = 1102,                   /* -mdirect-move */
  OPT_mdlmzb = 1103,                         /* -mdlmzb */
  OPT_mdouble_float = 1104,                  /* -mdouble-float */
  OPT_meabi = 1105,                          /* -meabi */
  OPT_memb = 1106,                           /* -memb */
  OPT_mfloat_gprs_ = 1107,                   /* -mfloat-gprs= */
  OPT_mfp_in_toc = 1108,                     /* -mfp-in-toc */
  OPT_mfprnd = 1109,                         /* -mfprnd */
  OPT_mfpu_ = 1110,                          /* -mfpu= */
  OPT_mfriz = 1111,                          /* -mfriz */
  OPT_mfull_toc = 1112,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1113, */              /* -mfused-madd */
  OPT_mgen_cell_microcode = 1114,            /* -mgen-cell-microcode */
  OPT_mhard_dfp = 1115,                      /* -mhard-dfp */
  OPT_mhard_float = 1116,                    /* -mhard-float */
  OPT_mhtm = 1117,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1118,            /* -minsert-sched-nops= */
  OPT_misel = 1119,                          /* -misel */
  /* OPT_misel_no = 1120, */                 /* -misel=no */
  /* OPT_misel_yes = 1121, */                /* -misel=yes */
  OPT_mlittle = 1122,                        /* -mlittle */
  OPT_mlittle_endian = 1123,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1124,                  /* -mlong-double- */
  OPT_mlongcall = 1125,                      /* -mlongcall */
  OPT_mlra = 1126,                           /* -mlra */
  OPT_mmfcrf = 1127,                         /* -mmfcrf */
  OPT_mmfpgpr = 1128,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1129,                   /* -mminimal-toc */
  OPT_mmulhw = 1130,                         /* -mmulhw */
  OPT_mmultiple = 1131,                      /* -mmultiple */
  OPT_mmvme = 1132,                          /* -mmvme */
  OPT_mnewlib = 1133,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1134,                  /* -mno-fp-in-toc */
  OPT_mno_sum_in_toc = 1135,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1136,                        /* -mno-toc */
  OPT_mno_traceback = 1137,                  /* -mno-traceback */
  OPT_mno_update = 1138,                     /* -mno-update */
  OPT_mnux = 1139,                           /* -mnux */
  OPT_mpaired = 1140,                        /* -mpaired */
  OPT_mpointers_to_nested_functions = 1141,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1142,                       /* -mpopcntb */
  OPT_mpopcntd = 1143,                       /* -mpopcntd */
  OPT_mpower8_fusion = 1144,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1145,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1146,                 /* -mpower8-vector */
  /* OPT_mpowerpc = 1147, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1148,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1149,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1150,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1151,  /* -mprioritize-restricted-insns= */
  OPT_mprototype = 1152,                     /* -mprototype */
  OPT_mquad_memory = 1153,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1154,            /* -mquad-memory-atomic */
  OPT_mrecip = 1155,                         /* -mrecip */
  OPT_mrecip_precision = 1156,               /* -mrecip-precision */
  OPT_mrecip_ = 1157,                        /* -mrecip= */
  OPT_mregnames = 1158,                      /* -mregnames */
  OPT_mrelocatable = 1159,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1160,               /* -mrelocatable-lib */
  OPT_ms2pp = 1161,                          /* -ms2pp */
  OPT_msave_toc_indirect = 1162,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1163,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1164,                  /* -msched-epilog */
  OPT_msched_groups = 1165,                  /* -msched-groups */
  OPT_msched_prolog = 1166,                  /* -msched-prolog */
  OPT_msdata = 1167,                         /* -msdata */
  OPT_msdata_ = 1168,                        /* -msdata= */
  OPT_msecure_plt = 1169,                    /* -msecure-plt */
  OPT_mshlib = 1170,                         /* -mshlib */
  OPT_msim = 1171,                           /* -msim */
  OPT_msimple_fpu = 1172,                    /* -msimple-fpu */
  OPT_msingle_float = 1173,                  /* -msingle-float */
  OPT_msingle_pic_base = 1174,               /* -msingle-pic-base */
  OPT_msoft_float = 1175,                    /* -msoft-float */
  OPT_mspe = 1176,                           /* -mspe */
  /* OPT_mspe_no = 1177, */                  /* -mspe=no */
  /* OPT_mspe_yes = 1178, */                 /* -mspe=yes */
  OPT_mstrict_align = 1179,                  /* -mstrict-align */
  OPT_mstring = 1180,                        /* -mstring */
  OPT_msum_in_toc = 1181,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1182,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1183,                   /* -mtls-markers */
  OPT_mtls_size_ = 1184,                     /* -mtls-size= */
  OPT_mtoc = 1185,                           /* -mtoc */
  OPT_mtraceback_ = 1186,                    /* -mtraceback= */
  OPT_mtune_ = 1187,                         /* -mtune= */
  OPT_mupdate = 1188,                        /* -mupdate */
  OPT_mupper_regs_df = 1189,                 /* -mupper-regs-df */
  OPT_mupper_regs_sf = 1190,                 /* -mupper-regs-sf */
  OPT_mveclibabi_ = 1191,                    /* -mveclibabi= */
  OPT_mvectorize_builtins = 1192,            /* -mvectorize-builtins */
  OPT_mvrsave = 1193,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1194, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1195, */              /* -mvrsave=yes */
  OPT_mvsx = 1196,                           /* -mvsx */
  OPT_mvsx_align_128 = 1197,                 /* -mvsx-align-128 */
  OPT_mvsx_scalar_double = 1198,             /* -mvsx-scalar-double */
  OPT_mvsx_scalar_float = 1199,              /* -mvsx-scalar-float */
  /* OPT_mvsx_scalar_memory = 1200, */       /* -mvsx-scalar-memory */
  OPT_mvsx_timode = 1201,                    /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1202,             /* -mwarn-altivec-long */
  OPT_mwarn_cell_microcode = 1203,           /* -mwarn-cell-microcode */
  OPT_mxilinx_fpu = 1204,                    /* -mxilinx-fpu */
  OPT_mxl_compat = 1205,                     /* -mxl-compat */
  OPT_myellowknife = 1206,                   /* -myellowknife */
  OPT_n = 1207,                              /* -n */
  OPT_no_canonical_prefixes = 1208,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1209,              /* -no-integrated-cpp */
  OPT_nocpp = 1210,                          /* -nocpp */
  OPT_nodefaultlibs = 1211,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1212,                   /* -nostartfiles */
  OPT_nostdinc = 1213,                       /* -nostdinc */
  OPT_nostdinc__ = 1214,                     /* -nostdinc++ */
  OPT_nostdlib = 1215,                       /* -nostdlib */
  OPT_o = 1216,                              /* -o */
  OPT_p = 1217,                              /* -p */
  OPT_pass_exit_codes = 1218,                /* -pass-exit-codes */
  /* OPT_pedantic = 1219, */                 /* -pedantic */
  OPT_pedantic_errors = 1220,                /* -pedantic-errors */
  OPT_pg = 1221,                             /* -pg */
  OPT_pie = 1222,                            /* -pie */
  OPT_pipe = 1223,                           /* -pipe */
  ...
  OPT_quiet = 1235,                          /* -quiet */
  OPT_r = 1236,                              /* -r */
  OPT_remap = 1237,                          /* -remap */
  OPT_s = 1238,                              /* -s */
  OPT_s_bc_abi = 1239,                       /* -s-bc-abi */
  OPT_save_temps = 1240,                     /* -save-temps */
  OPT_save_temps_ = 1241,                    /* -save-temps= */
  OPT_shared = 1242,                         /* -shared */
  OPT_shared_libgcc = 1243,                  /* -shared-libgcc */
  /* OPT_specs = 1244, */                    /* -specs */
  OPT_specs_ = 1245,                         /* -specs= */
  OPT_static = 1246,                         /* -static */
  OPT_static_libasan = 1247,                 /* -static-libasan */
  OPT_static_libgcc = 1248,                  /* -static-libgcc */
  OPT_static_libgcj = 1249,                  /* -static-libgcj */
  OPT_static_libgfortran = 1250,             /* -static-libgfortran */
  OPT_static_libgo = 1251,                   /* -static-libgo */
  OPT_static_liblsan = 1252,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1253,               /* -static-libstdc++ */
  OPT_static_libtsan = 1254,                 /* -static-libtsan */
  OPT_static_libubsan = 1255,                /* -static-libubsan */
  /* OPT_std_c__03 = 1256, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1257, */                /* -std=c++0x */
  OPT_std_c__11 = 1258,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1259, */                /* -std=c++14 */
  OPT_std_c__1y = 1260,                      /* -std=c++1y */
  ...
  OPT_std_gnu__1y = 1277,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1278,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1279,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1280, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1281, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1282,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1283,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1284, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1285, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1286,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1287, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1288, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1289, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1290,                     /* -std=legacy */
  OPT_symbolic = 1291,                       /* -symbolic */
  OPT_t = 1292,                              /* -t */
  OPT_time = 1293,                           /* -time */
  OPT_time_ = 1294,                          /* -time= */
  OPT_traditional = 1295,                    /* -traditional */
  OPT_traditional_cpp = 1296,                /* -traditional-cpp */
  OPT_trigraphs = 1297,                      /* -trigraphs */
  OPT_u = 1298,                              /* -u */
  OPT_undef = 1299,                          /* -undef */
  OPT_v = 1300,                              /* -v */
  OPT_version = 1301,                        /* -version */
  OPT_w = 1302,                              /* -w */
  OPT_wrapper = 1303,                        /* -wrapper */
  OPT_x = 1304,                              /* -x */
  OPT_z = 1305,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
