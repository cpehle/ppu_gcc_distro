/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../gcc/gcc/config/rs6000/rs6000.md'.  */
...
extern int s2pp_register_operand (rtx, enum machine_mode);
extern int s2pp_cond_register_operand (rtx, enum machine_mode);
extern int s2pp_acc_register_operand (rtx, enum machine_mode);
...
extern int u3bit_cint_operand (rtx, enum machine_mode);
extern int u5bit_cint_operand (rtx, enum machine_mode);
extern int s8bit_cint_operand (rtx, enum machine_mode);
extern int u10bit_cint_operand (rtx, enum machine_mode);
...
extern int int_reg_operand (rtx, enum machine_mode);
extern int base_reg_operand (rtx, enum machine_mode);
extern int htm_spr_reg_operand (rtx, enum machine_mode);
extern int quad_int_reg_operand (rtx, enum machine_mode);
...
extern int vsx_reg_or_cint_operand (rtx, enum machine_mode);
...
extern int quad_memory_operand (rtx, enum machine_mode);
...
extern int s2pp_indexed_or_indirect_operand (rtx, enum machine_mode);
extern int indexed_or_indirect_address (rtx, enum machine_mode);
extern int indexed_address (rtx, enum machine_mode);
extern int update_address_mem (rtx, enum machine_mode);
extern int update_indexed_address_mem (rtx, enum machine_mode);
...
extern int vsx_scalar_64bit (rtx, enum machine_mode);
...
extern int crsave_operation (rtx, enum machine_mode);
...
extern int fusion_gpr_addis (rtx, enum machine_mode);
extern int fusion_gpr_mem_load (rtx, enum machine_mode);
extern int fusion_gpr_mem_combo (rtx, enum machine_mode);
